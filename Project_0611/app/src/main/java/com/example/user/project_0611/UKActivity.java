...
public class UKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new UKActivity.BackgroundTask().execute();
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://dyrnfmxm9.cafe24.com/fwNation.php?resNation=" + URLEncoder.encode("UnitedKingdom", "UTF-8");
        ...
        public void onPostExecute(String result){
            try{
                ...
                if(count==0){
                    AlertDialog dialog;
                    AlertDialog.Builder builder = new AlertDialog.Builder(UKActivity.this);
