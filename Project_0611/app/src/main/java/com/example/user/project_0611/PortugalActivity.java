...
public class PortugalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new PortugalActivity.BackgroundTask().execute();
        final ImageButton homeButton = (ImageButton) findViewById(R.id.home_button);

        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PortugalActivity.this , MainActivity.class);
                PortugalActivity.this.startActivity(intent);
        ...
        view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent (PortugalActivity.this, InfoActivity.class);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://dyrnfmxm9.cafe24.com/fwNation.php?resNation=" + URLEncoder.encode("Portugal", "UTF-8");
        ...
        public void onPostExecute(String result){
            try{
                ...
                if(count==0){
                    AlertDialog dialog;
                    AlertDialog.Builder builder = new AlertDialog.Builder(PortugalActivity.this);
