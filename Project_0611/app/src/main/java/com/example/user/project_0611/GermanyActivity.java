...
public class GermanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GermanyActivity.BackgroundTask().execute();
        final ImageButton homeButton = (ImageButton) findViewById(R.id.home_button);

        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GermanyActivity.this , MainActivity.class);
                GermanyActivity.this.startActivity(intent);
        ...
        view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent (GermanyActivity.this, InfoActivity.class);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://dyrnfmxm9.cafe24.com/fwNation.php?resNation=" + URLEncoder.encode("Germany", "UTF-8");
        ...
        public void onPostExecute(String result){
            try{
                ...
                if(count==0){
                    AlertDialog dialog;
                    AlertDialog.Builder builder = new AlertDialog.Builder(GermanyActivity.this);
